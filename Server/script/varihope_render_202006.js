	...
	window.PIEL.REPORT.logic = function( data ){
        ...
        am4core.ready(function() {
            ...
            var google_age_title_a = [
                ...
                , [ "Chiến Dịch Video – 2020-06-25 Discovery", "youtube skip ads" ]
                , [ "Chiến Dịch Video – 2020-06-25 Inside", "youtube skip ads" ]
            ];
    		...
    		window.charts.pie[ google_age_title_a[ 4 ][ 0 ] ] = window.PIEL.REPORT.pieChartAge( "chartdiv11", google_age_title_a[ 4 ], data.google_ages_data[ "Chiến Dịch Video – 2020-06-25 Discovery----youtube skip ads" ] );
    		window.charts.pie[ google_age_title_a[ 5 ][ 0 ] ] = window.PIEL.REPORT.pieChartAge( "chartdiv12", google_age_title_a[ 5 ], data.google_ages_data[ "Chiến Dịch Video – 2020-06-25 Inside----youtube skip ads" ] );
