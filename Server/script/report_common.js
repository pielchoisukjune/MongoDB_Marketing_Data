		...
		for(;i<iLen;i++){
			...
			if( i == 0 ){
				...
				io.forEach(function(item){
					...
					if( _tidx == 0 )
					{
						_html0 += "<th style='width:18%;font-weight: 400;font-size: 14px;'>" + _item + "</th>\n";
					}
					else if( _tidx == 1 ){
						_html0 += "<th style='width:19%;font-weight: 400;font-size: 14px;'>" + _item + "</th>\n";
					}
					else
					{
						
						if( _bg_check00 == _tidx ) _html0 += "<th style='width:9%;background-color : red;color:#fff;font-weight: 400;font-size: 14px;'>" + _item + "</th>\n";
						else if( _bg_check01 == _tidx ) _html0 += "<th style='width:9%;background-color : yellow;color:red;font-weight: 400;font-size: 14px;'>" + _item + "</th>\n";
						else _html0 += "<th style='width:9%;font-weight: 400;font-size: 14px;'>" + _item + "</th>\n";
					}
					++_tidx;
				})
				_html0 += "</tr>\n"
			...
			else
			{
				...
				io.forEach(function(item){ 
					...
					else _html1 += "<td style='font-size:14px;'>" + _item + "</td>\n"; 
					++_tidx;
				})
				_html1 += "</tr>\n"
			}
